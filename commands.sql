...
insert into reading_list (user_id, blog_id) values (1, 2);
insert into reading_list (user_id, blog_id) values (1, 3);
insert into reading_list (user_id, blog_id) values (2, 3);
insert into reading_list (user_id, blog_id) values (2, 4);